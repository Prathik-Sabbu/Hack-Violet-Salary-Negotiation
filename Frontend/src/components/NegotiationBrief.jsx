...
function PreNegotiationBrief({ playerData, onClose }) {
  ...
  // Calculate target salary on mount
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="bg-yellow-50 border-8 border-gray-800 shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto my-4 relative">
        <div
          ...
          <div className="relative z-10 pl-12">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              ...
              >
                ...
                <p className="text-xl font-bold">
                  {formatCurrency(targetData.targetRange[0])} –{' '}
                  {formatCurrency(targetData.targetRange[1])}
                </p>
                  ...
                  <div className="absolute z-10 w-72 p-4 bg-gray-900 text-white text-xs rounded-lg shadow-xl left-1/2 -translate-x-1/2 -top-2 -translate-y-full">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex justify-between text-green-300">
                        ...
                        <span>
                          +{formatCurrency(targetData.calculation.bonusAmount)}
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between font-bold">
                        <span>Target</span>
                        <span>
                          {formatCurrency(targetData.calculation.targetSalary)}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            {playerData.achievements.length > 0 && (
              <div className="mb-6">
                <h3 className="text-lg font-bold mb-3 border-b-2 border-gray-800 pb-2">
                  Your Achievements
                </h3>
