          ...
          <div className="relative z-10 pl-12">
            ...
            <div className="mb-8">
              ...
              <div className="bg-white/80 rounded-lg p-4">
                <p className="text-gray-800 text-xl leading-relaxed" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.5rem' }}>
            ...
            {/* How It Works */}
            <div className="mb-8">
              <h3 className="text-3xl font-bold text-green-700 mb-4" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '2.125rem' }}>
                📋 How It Works
              </h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-xl" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.5rem' }}>Review Your Brief</p>
                    <p className="text-gray-700 text-lg" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.375rem' }}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-xl" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.5rem' }}>Talk to Shlok</p>
                    <p className="text-gray-700 text-lg" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.375rem' }}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-xl" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.5rem' }}>Watch the Offers</p>
                    <p className="text-gray-700 text-lg" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.375rem' }}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-xl" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.5rem' }}>Reach Your Goal</p>
                    <p className="text-gray-700 text-lg" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.375rem' }}>
            ...
            {/* Pro Tips */}
            <div className="mb-8">
              <h3 className="text-3xl font-bold text-purple-700 mb-4" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '2.125rem' }}>
                💡 Pro Tips
              </h3>
              <div className="bg-purple-50 rounded-lg p-4 space-y-2">
                <p className="text-gray-800 text-lg" style={{ fontFamily: 'vt323-regular-webfont, monospace', fontSize: '1.375rem' }}>
